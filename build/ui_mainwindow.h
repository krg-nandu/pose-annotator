...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setGeometry(QRect(330, 280, 311, 51));
        vangle = new QSlider(groupBox);
        vangle->setObjectName(QString::fromUtf8("vangle"));
        vangle->setGeometry(QRect(10, 27, 291, 20));
        vangle->setOrientation(Qt::Horizontal);
        groupBox_2 = new QGroupBox(panel);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        groupBox_2->setGeometry(QRect(330, 330, 311, 51));
        scale = new QSlider(groupBox_2);
        scale->setObjectName(QString::fromUtf8("scale"));
        scale->setGeometry(QRect(11, 28, 291, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setTitle(QApplication::translate("MainWindow", "Sideview viewing angle", 0, QApplication::UnicodeUTF8));
        groupBox_2->setTitle(QApplication::translate("MainWindow", "Scale", 0, QApplication::UnicodeUTF8));
