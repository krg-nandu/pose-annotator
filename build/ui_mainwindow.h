...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        scale_label = new QLabel(panel);
        scale_label->setObjectName(QString::fromUtf8("scale_label"));
        scale_label->setGeometry(QRect(330, 280, 67, 17));
        QFont font1;
        font1.setBold(true);
        font1.setWeight(75);
        scale_label->setFont(font1);
        scale = new QSlider(panel);
        scale->setObjectName(QString::fromUtf8("scale"));
        scale->setGeometry(QRect(370, 280, 261, 16));
        scale->setOrientation(Qt::Horizontal);
        vangle = new QSlider(panel);
        vangle->setObjectName(QString::fromUtf8("vangle"));
        vangle->setGeometry(QRect(370, 310, 261, 16));
        vangle->setOrientation(Qt::Horizontal);
        vangle_label = new QLabel(panel);
        vangle_label->setObjectName(QString::fromUtf8("vangle_label"));
        vangle_label->setGeometry(QRect(330, 310, 67, 17));
        vangle_label->setFont(font1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        vangle_label->setText(QApplication::translate("MainWindow", "View", 0, QApplication::UnicodeUTF8));
